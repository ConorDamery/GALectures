...
namespace GASandbox
{
    ...
    struct sSfxChannel
    {
        f32 volume{ 1.0f };
        bool active{ true };
        list<sSfxInstance> instances{};

        sSfxChannel() = default;
        sSfxChannel(f32 volume, bool active)
    ...
    {
        ma_device device{};
        list<sSfxAudio> audios{};
        list<sSfxChannel> channels{};
    ...
    {
        auto* data = static_cast<sSfxGlobal*>(pDevice->pUserData);
    ...
    static sSfxChannel* sfx_get_channel(u32 channel)
    {
    ...
    static sSfxAudio* sfx_get_audio(u32 audio)
    {
    ...
    {
        g.channels.emplace_back(sSfxChannel{ volume, true });
