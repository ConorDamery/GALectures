...
class R410 {
  public:
    ...
    R410 (float f, int idx=0) { std::fill( mvec, mvec + sizeof( mvec )/4, 0.0f ); mvec[idx] = f; }
    float& operator [] (size_t idx) { return mvec[idx]; }
    const float& operator [] (size_t idx) const { return mvec[idx]; }
    R410 log () { int n=0; for (int i=0,j=0;i<32;i++) if (mvec[i]!=0.0f) { n++; printf("%s%0.7g%s",(j>0)?" + ":"",mvec[i],(i==0)?"":basis[i]); j++; };if (n==0) printf("0");  printf("\n"); return *this; }
    R410 Conjugate(); 
    R410 Involute();
    float norm();
    float inorm();
...
//***********************
inline R410 operator ~ (const R410 &a) {
  R410 res;
  res[0]=a[0];
  res[1]=a[1];
  res[2]=a[2];
...
//***********************
inline R410 operator * (const R410 &a, const R410 &b) {
  R410 res;
...
//***********************
inline R410 operator * (const float &a, const R410 &b) {
  R410 res;
      res[0] = a*b[0];
    res[1] = a*b[1];
    res[2] = a*b[2];
...
//***********************
inline R410 operator * (const R410 &a, const float &b) {
  R410 res;
      res[0] = a[0]*b;
    res[1] = a[1]*b;
    res[2] = a[2]*b;
...
inline float R410::norm() { return sqrt(std::abs(((*this)*Conjugate()).mvec[0])); }
inline float R410::inorm() { return (!(*this)).norm(); }
inline R410 R410::normalized() { return (*this) * (1/norm()); }


static R410 e1(1.0f,1);
static R410 e2(1.0f,2);
static R410 e3(1.0f,3);
static R410 e4(1.0f,4);
static R410 e5(1.0f,5);
static R410 e12(1.0f,6);
static R410 e13(1.0f,7);
static R410 e14(1.0f,8);
static R410 e15(1.0f,9);
static R410 e23(1.0f,10);
static R410 e24(1.0f,11);
static R410 e25(1.0f,12);
static R410 e34(1.0f,13);
static R410 e35(1.0f,14);
static R410 e45(1.0f,15);
static R410 e123(1.0f,16);
static R410 e124(1.0f,17);
static R410 e125(1.0f,18);
static R410 e134(1.0f,19);
static R410 e135(1.0f,20);
static R410 e145(1.0f,21);
static R410 e234(1.0f,22);
static R410 e235(1.0f,23);
static R410 e245(1.0f,24);
static R410 e345(1.0f,25);
static R410 e1234(1.0f,26);
static R410 e1235(1.0f,27);
static R410 e1245(1.0f,28);
static R410 e1345(1.0f,29);
static R410 e2345(1.0f,30);
static R410 e12345(1.0f,31);


int main (int argc, char **argv) {
  
  printf("e1*e1         : "); (e1*e1).log();
  printf("pss           : "); e12345.log();
  printf("pss*pss       : "); (e12345*e12345).log();
